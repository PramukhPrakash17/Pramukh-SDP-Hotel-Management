...
public class BookingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("role") == null || session.getAttribute("role") == "admin") {
			...
			Room room = new Room(bookingID,roomNumber,status,checkInDate,checkOutDate,roomType,roomView,price,email);
			try {
		...
		response.sendRedirect("booking?bookingID=" + bookingID + "&roomNumber=" + roomNumber + "&checkIn=" + checkIn
				+ "&checkOut=" + checkOut);
	}
}
